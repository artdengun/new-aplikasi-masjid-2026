        ...
        <div class="container-fluid  text-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><i class="nav-icon fas  fa-users"></i> Laporan Data Muazin</li>
                </ol>
            </nav>
        </div>
    </div>
          ...
          <div class="row ms-2 mb-3">
              ...
              <div class="row ms-2">
                <div class="col-md-4" id="selectedTanggal" style="display: none;">
                  <form action="<?= base_url() ?>/MuazinController/filter" method="post">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($daftarmuazin as $row) { ?>
                                        <tr>
