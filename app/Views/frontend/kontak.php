                ...
                <div class="col-lg-4">
                    ...
                    <div class="info">
                        ...
                        <div class="info-item d-flex">
                            ...
                            <div>
                                <h4>Alamat:</h4>
                                <p>Jl. Wibawa Mukti II Jl. Diman, RT.004/RW.006, Jatisari, Kec. Jatiasih, Kota Bekasi,
                                    Jawa Barat 17426</p>
                            </div>
                        </div><!-- End Info Item -->
                    ...
                    <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                        ...
                        <div class="form-group mt-3">
                            <input type="text" class="form-control" name="subject" id="subject"
                                placeholder="Judul Email" required="">
                        </div>
                        <div class="form-group mt-3">
                            <textarea class="form-control" name="message" placeholder="Pesan Email ..."
                                required=""></textarea>
                        </div>
                        <div class="my-3">
