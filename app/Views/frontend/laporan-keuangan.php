                    ...
                    <div class="container">
                        <div class="categories-menu"
                            ...
                            <ul class="nav nav-tabs"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#laporan-jumat"
                                        style="flex-shrink: 0;">Laporan
                                        Jumat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#laporan-tahunan"
                                        style="flex-shrink: 0;">Laporan
                                        Tahunan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#laporan-lainnya"
                                        style="flex-shrink: 0;">Laporan
                                        Lainnya</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#laporan-lengkap"
                                        style="flex-shrink: 0;">Laporan
                                        Lengkap</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#laporan-proyek"
                                        style="flex-shrink: 0;">Laporan
                                        Proyek</a>
                                </li>
                            </ul>
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="tab-pane fade show active" id="laporan-keuangan">
                                ...
                                <input type="text" class="search-input" placeholder="Cari di tabel..."
                                    data-target="table-keuangan">
