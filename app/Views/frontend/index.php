...
<main class="main">
    ...
    <section id="hero" class="hero section dark-background">
        ...
        <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="2000">
            <!-- Carousel Item 0: Selamat Datang di Masjid Al-Hikmah -->
            <div class="carousel-item active">
                <img src="assets/img/ui/masjid_ui.png" alt="Masjid Al-Hikmah">
                <div class="carousel-container">
                    <h2>Kata Pengantar Ketua Dewan Kemakmuran Masjid Al-Hikmah</h2>
                    <p>Selamat datang di Masjid Al-Hikmah, tempat di mana kita bersama-sama membangun keimanan dan
                        ukhuwah. Kami mengundang Anda untuk ikut serta dalam berbagai kegiatan bermanfaat di masjid
                        kami.</p>
                    <span>Disampaikan oleh: <a>Ust. H. Imam Nawawi</a></span>
                </div>
            </div><!-- End Carousel Item -->

            <!-- Carousel Item 1: Gambar Anak Yatim Sholat -->
            <div class="carousel-item">
                <img src="assets/img/ui/anak_yatim.jpeg" alt="Anak Yatim Sholat">
                <div class="carousel-container">
                    <h2>Program Santunan Anak Yatim</h2>
                    <p>Bersama-sama kita bantu anak-anak yatim untuk tetap semangat dalam belajar dan beribadah. Mari
                        berbagi kebaikan untuk masa depan mereka.</p>
                </div>
            </div><!-- End Carousel Item -->

            <!-- Carousel Item 2: Gambar Pengajian Bersama -->
            <div class="carousel-item">
                <img src="assets/img/ui/penyaluran_zakat.jpg" alt="Pengajian di Masjid">
                <div class="carousel-container">
                    <h2>Penyaluran Zakat</h2>
                    <p>Masjid Al-Hikmah memfasilitasi penyaluran zakat kepada yang berhak menerima, membantu mereka yang
                        membutuhkan dan memberdayakan masyarakat.</p>
                </div>
            </div><!-- End Carousel Item -->

            <!-- Carousel Item 3: Gambar Belajar Al-Qur'an -->
            <div class="carousel-item">
                <img src="assets/img/ui/penyaluran_qurban.jpg" alt="Belajar Al-Qur'an">
                <div class="carousel-container">
                    <h2>Penyaluran Qurban</h2>
                    <p>Bergabunglah dalam program penyaluran qurban Masjid Al-Hikmah, yang mendistribusikan daging
                        qurban kepada masyarakat yang membutuhkan dengan penuh tanggung jawab.</p>
                </div>
            </div><!-- End Carousel Item -->

            <!-- Carousel Item 4: Gambar Sholat Berjamaah -->
            <div class="carousel-item">
                <img src="assets/img/ui/sholat_berjamaah.jpg" alt="Sholat Berjamaah">
                <div class="carousel-container">
                    <h2>Sholat Berjamaah dan Ceramah</h2>
                    <p>Ikuti sholat berjamaah di Masjid Al-Hikmah yang dilanjutkan dengan ceramah singkat dari para
                        ustaz untuk memperkuat iman dan takwa.</p>
                </div>
            </div><!-- End Carousel Item -->

            <!-- Carousel Item 5: Gambar Kegiatan Sosial di Masjid -->
            <div class="carousel-item">
                <img src="assets/img/ui/program_sosial.jpg" alt="Kegiatan Sosial di Masjid">
                <div class="carousel-container">
                    <h2>Program Sosial dan Berbagi</h2>
                    <p>Masjid Al-Hikmah mengadakan berbagai kegiatan sosial seperti pembagian sembako, layanan kesehatan
                        gratis, dan santunan untuk mereka yang membutuhkan.</p>
                </div>
            </div><!-- End Carousel Item -->
    ...
    <section id="services" class="services section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Layanan Masjid Al Hikmah</h2>
            <p>Informasi Pelayanan yang dapat di layanai oleh Masjid Al Hikmah Payangan</p>
                ...
                <div class="row g-0">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Sholat Berjamaah</h3>
                                <p>Masjid menyediakan tempat untuk sholat berjamaah lima waktu dengan imam dan muadzin
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Penyaluran Zakat dan Infak</h3>
                                <p>Penerimaan dan penyaluran zakat fitrah, mal, serta infak kepada yang berhak menerima.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Manajemen Qurban</h3>
                                <p>Melayani penerimaan hewan qurban, penyembelihan, dan distribusi kepada masyarakat
                                    yang membutuhkan.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Konsultasi Agama</h3>
                                <p>Menyediakan waktu untuk konsultasi agama bersama ustaz bagi jamaah yang membutuhkan
                                    bimbingan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0" y="0"
                                    viewBox="0 0 514.314 514.314" style="enable-background: new 0 0 512 512"
                                    xml:space="preserve" class="">
                                    <g>
                                        <path
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Pendampingan Muallaf</h3>
                                <p>Menyediakan bimbingan dan pendampingan untuk muallaf agar lebih memahami ajaran Islam
                                    dengan baik.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Layanan Jenazah</h3>
                                <p>Menyediakan layanan mulai dari memandikan, mengkafani, hingga mengantarkan jenazah ke
                                    tempat pemakaman.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Peminjaman Al-Qur'an</h3>
                                <p>Menyediakan Al-Qur'an untuk dipinjam oleh jamaah selama berada di masjid atau untuk
                                    kegiatan belajar.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Pelayanan Konseling Keluarga</h3>
                                <p>Menyediakan konseling keluarga untuk membantu jamaah dalam menghadapi masalah rumah
                                    tangga atau kehidupan.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="testimonials-12 testimonials section" id="testimonials">
        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
            <h2>Review Google Maps</h2>
            <p>Ulasan Positif Tentang Masjid Alhikmah </p>
        </div><!-- End Section Title -->
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 mb-md-4">
                        <div class="testimonial">
                            <img src="assets/img/testimonials/smile_1.png" alt="Testimonial author">
                            <blockquote>
                                <p>
                                    "Sangat nyaman di masjid ini tempat nya bersih dan sejuk, dan aman"
                                </p>
                            </blockquote>
                            <div class="rating">
                                <span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span>
                            </div>
                            <p class="client-name">Salman Putra</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 mb-md-4">
                        <div class="testimonial">
                            ...
                            <blockquote>
                                <p>
                                    "Ruangan sholatnya ber AC, ta'lim nya variatif. Nyaman dan adem.""
                                </p>
                            </blockquote>
                            <div class="rating">
                                <span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span>
                            </div>
                            <p class="client-name">Frans Mustafa</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 mb-md-4">
                        <div class="testimonial">
                            ...
                            <blockquote>
                                <p>
                                    "Tempat yg bersih dan nyaman untuk beribadah"
                                </p>
                            </blockquote>
                            <div class="rating">
                                <span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span>
                            </div>
                            <p class="client-name">Jafran Pratama </p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 mb-md-4">
                        <div class="testimonial">
                            ...
                            <blockquote>
                                <p>
                                    “Sangat terjaga kebersihan masjidnya”
                                </p>
                            </blockquote>
                            <div class="rating">
                                <span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span><span>&#9733;</span>
                            </div>
                            <p class="client-name">Alwi Alfaqih</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-5">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="<?php echo base_url('assets/img/event/sholat_subuh_gabungan.png'); ?>"
                                class="img-fluid" alt="Event Sholat Subuh Gabungan">
                        ...
                        <div class="post-content d-flex flex-column">
                            ...
                            <a href="https://www.instagram.com/p/CTEAaV3p-b1/" class="readmore stretched-link"
                                target="_blank"><span>Baca Lebih Lengkap ...</span><i class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="<?php echo base_url('assets/img/event/zakat_fitrah.png'); ?>" class="img-fluid"
                                alt="">
                        ...
                        <div class="post-content d-flex flex-column">
                            ...
                            <a href="https://www.instagram.com/p/COZsfQHrbO-/" class="readmore stretched-link"
                                target="_blank"><span>Baca Lebih Lengkap ...</span><i class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="post-item position-relative h-100">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="<?php echo base_url('assets/img/event/donasi_hewan_qurban.png');?>"
                                class="img-fluid" alt="">
                        ...
                        <div class="post-content d-flex flex-column">
                            ...
                            <a href="https://www.instagram.com/p/CPUe3DRrA_-/" class="readmore stretched-link"
                                target="_blank"><span>Baca Lebih Lengkap ...</span><i class="bi bi-arrow-right"></i></a>
