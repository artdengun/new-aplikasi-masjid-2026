...
<main class="main">
        ...
        <div class="container">
            <div class="row gy-4 justify-content-between align-items-center">
                <div class="col-lg-6 order-lg-2 position-relative" data-aos="zoom-out">
                    <img src="assets/logo/brand.png" alt="Image" class="img-fluid">
                </div>
                <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                    <h2 class="content-title mb-4">Sejarah Masjid Al-Hikmah Payangan</h2>
                    <p class="mb-4">
                        Masjid Al-Hikmah (dahulu bernama Mushola Al-Hikmah) merupakan salah satu tempat peribadahan umat
                        Islam
                        tertua di kelurahan Jati Sari dan Masjid tertua ke-2 di Kampung Payangan. Didirikan pada tahun
                        1980 di atas
                        seluas tanah 210 M oleh pewaqif Alm. H.Toyyib dan diserahkan kepada Nadzir Ust.Siman dengan dua
                        orang saksi
                        yakni Alm. Bpk. Sakim dan Kepala Desa Jati Luhur yakni Alm. Bpk. Senan dan di tanda tangani oleh
                        Ketua
                        Kantor Urusan Agama Kecamatan Pondok Gede yakni Alm. H. Abdillah pada hari Sabtu, 2 Rabi'ul
                        Awwal 1403 H
                        atau bertepatan pada tanggal 15 Januari 1983 (tanggal terbit Akta Wakaf).
                        Penamaan Al-Hikmah sendiri adalah hasil sumbangan pemikiran Alm. Bpk. Genih, yang bermakna
                        Lambang
                        Kebijaksanaan yang melampaui Ilmu Pengetahuan, Hikmah dapat juga dimaknai 'tengah' sebagaimana
                        letak
    ...
    <section id="services" class="services section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Visi Dan Misi</h2>
            <p>Masjid Al Hikmah Memiliki visi dan misi untuk menunjang semangatnya proses memakmurkan masjid</p>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Menjadi Masjid Yang Nyaman Untuk beribadah</h3>
                                <hr>
                                <p>
                                    Menjadikan Sarana Peribadahan Yang Rahmatan Lil'Aalamiin,
                                    Berdasarkan Al-Quran & Hadits
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Masjid Yang Bersih</h3>
                                <p>Terwujudnya Masjid Yang Bersih, Rapih Dan Nyaman
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading"> Prasarana Pengembangan Ilmu Agama</h3>
                                <p>Menjadi Lembaga Dakwah, Pendidikan, Pengembangan Ilmu Serta Budaya Islami
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0" y="0"
                                    viewBox="0 0 516.53 516.53" style="enable-background: new 0 0 512 512"
                                    xml:space="preserve" class="">
                                    <g>
                                        <path
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading"> Pengembangan Iman Dan Takwa</h3>
                                <p>
                                    Meningkatkan Ekonomi Pemberdayaan Umat Yang Dilandasi Oleh Keimanan Dan Ketaqwaan
                                    Kepada Allah SWT
                                </p>
                            </div>
                        </div>
