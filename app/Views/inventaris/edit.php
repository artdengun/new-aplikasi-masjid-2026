            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('inventaris/save'); ?>" method="post" class="form-transaksi">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_barang" class="form-control"
                                            placeholder="Contoh: INV-001" value="<?= $inventaris['kode_barang']; ?>"
                                            required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_barang" class="form-control"
                                            placeholder="Contoh: Speaker TOA" value="<?= $inventaris['nama_barang']; ?>"
                                            required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="kategori" class="form-select" required>
                                            ...
                                            <option
                                                <?= $inventaris['kategori'] == 'Perlengkapan Ibadah' ? 'selected' : '' ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="jumlah" class="form-control" placeholder="Contoh: 10"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tanggal_beli" class="form-control"
                                            value="<?= $inventaris['tanggal_beli']; ?>" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <!-- 🔥 wajib id jumlah -->
                                        <input type="text" id="jumlah" name="harga" class="form-control"
                                            placeholder="Contoh: 5.000.000"
                                            value="<?= number_format($inventaris['harga'],0,',','.'); ?>" required>
