    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <?php } ?>
          <div class="card">
            <?php echo form_open_multipart('daftarynz/update/' . $daftarynz['idynz']); ?>
            <div class="card-header">Form Edit Produk</div>
            <div class="card-body">
              <?php echo form_hidden('idynz', $daftarynz['idynz']); ?>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <?php echo form_label('Nama Pengurus', 'Category'); ?>
                    <?php echo form_dropdown('idpengurus', $daftarpengurus, $daftarynz['idpengurus'], ['class' => 'form-control']); ?>
                  </div>
                  <div class="form-group">
                    <?php echo form_label('nama', 'Name'); ?>
                    <?php echo form_input('nama', $daftarynz['nama'], ['class' => 'form-control', 'placeholder' => 'Product Name']); ?>
                  </div>
                  <div class="form-group">
                    <?php echo form_label('Alamat', 'Price'); ?>
                    <?php echo form_input('alamat', $daftarynz['alamat'], ['class' => 'form-control', 'placeholder' => 'Product Price', 'type' => 'text']); ?>
                  </div>
                  <div class="form-group">
                    <?php echo form_label('Handphone', 'Handphone'); ?>
                    <?php echo form_input('handphone', $daftarynz['handphone'], ['class' => 'form-control', 'placeholder' => 'Product SKU', 'type' => 'number']); ?>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <?php echo form_label('Status Jamaah', 'Status Jamaah'); ?>
                    <?php echo form_dropdown('status_ynz', ['' => 'Pilih', 'YATIM' => 'YATIM', 'YATIM PIATU' => 'YATIM PIATU', 'JANDA' => 'JANDA', 'DHUAFA' => 'DHUAFA'], $daftarynz['status_ynz'], ['class' => 'form-control']); ?>
                  </div>
                  <div class="form-group">
                    <?php echo form_label('Tanggal Masuk', 'Description'); ?>
                    <?php echo form_input('tahun', $daftarynz['tahun'], ['class' => 'form-control', 'placeholder' => 'Product Description']); ?>
                  </div>
                </div>
              </div>
            </div>
