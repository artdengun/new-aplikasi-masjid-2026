                                    ...
                                    <?php foreach ($daftarmarbot as $row) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('daftarmarbot/edit/' . $row['idmarbot']); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="<?php echo base_url('daftarmarbot/delete/' . $row['idmarbot']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus Data ini?');">
