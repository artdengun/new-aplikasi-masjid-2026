    ...
    <div class="content-header">
        <div class="container-fluid  text-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url('/dasboard') ?>"> <i class="nav-icon fas  fa-mosque"></i> Dashboard</a></li>
          ...
          <div class="row ms-2 mb-3">
              ...
              <div class="row ms-2">
                <div class="col-md-4" id="selectedTanggal" style="display: none;">
                  <form action="<?= base_url() ?>/KhotibController/filter" method="post">
